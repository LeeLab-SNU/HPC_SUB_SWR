...
% 
    ...
    thisPool_Sig_L =  thisPool(thisPool.Selectivity_LScene>=1 & thisPool.Selectivity_LScene<4,:);
    thisPool_Sig_R = thisPool(thisPool.Selectivity_RScene>=1 & thisPool.Selectivity_RScene<4,:);
    thisPool_Sig_C =  thisPool(thisPool.Selectivity_LR>=1 & thisPool.Selectivity_LR<4,:);
